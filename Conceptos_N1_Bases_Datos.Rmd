...
## ¿Cuantos estudiantes hay por genero (ESTU_GENERO)?
...
## ¿Por departamento, cuántos del género femenino y cuántos del género masculino?
...
## Distribución por género para cada uno de los municipios.
...
## Distribución para el desempeño en Inglés (DESEMP_INGLES) por municipios.
...
## promedio del puntaje global para clos municipios del departamento del Cesar.
...
## Promedio de:lectura crítica, matemáticas, ciencias naturales, competencia ciudadana
...
# \textcolor{blue}{Base de Datos de Covid 19 en Colombia}
...
data <- read.csv("C:\\Users\\Estudiantes\\Videos\\Data_Clases_Unal\\Casos_positivos_de_COVID-19_en_Colombia.csv", stringsAsFactors = FALSE, sep = ";")
...
write.csv(data, "path/to/your/converted_file.csv", row.names = FALSE)
